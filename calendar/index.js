! function (e) {
  ...
  function (e, t, a) {
    ...
    }, t.convertEnableAreaToTimestamp = d, t.converEnableDaysToTimestamp = b, t.initialTasks = t.GetDate = t.Slide = t.Logger = void 0;
    class s {
      info(e) {
  ...
  function (e, t, a) {
    ...
    const n = {
      ...
      lYearDays: function (e) {
        ...
        for (s = 1900; s < 2101 && l > 0; s++) l -= c = n.lYearDays(s);
        l < 0 && (l += c, s--);
        const d = new Date;
        let b = !1;
        d.getFullYear() === +e && d.getMonth() + 1 === +t && d.getDate() === +a && (b = !0);
        let f = r.getDay();
        const i = n.nStr1[f];
        0 == +f && (f = 7);
        const h = s;
        ...
        let T = !1,
          M = null; + p === a && (T = !0, M = n.solarTerm[2 * t - 2]), +w === a && (T = !0, M = n.solarTerm[2 * t - 1]);
        ...
        let d = 0,
          b = !1;
        for (let a = 1; a < t; a++) d = n.leapMonth(e), b || d <= a && d > 0 && (l += n.leapDays(e), b = !0), l += n.monthDays(e, a);
        r && (l += o);
    ...
    class f extends n.default {
      ...
      switchWeek(e, t) {
        return new Promise((a, n) => {
          if ((0, s.default)(this.Component).getCalendarConfig().multi) return b.warn("多选模式不能切换周月视图");
          const {
            selectedDay: o = [],
            curYear: c,
            curMonth: l
          ...
          if ("week" === e) {
            ...
            if (c !== r || l !== s) return this.__tipsWhenCanNotSwtich();
      ...
      updateCurrYearAndMonth(e) {
        ...
        return (c.day + 7 > o || n === r && r !== s) && "next" === e ? (n += 1) > 12 && (a += 1, n = 1) : (+l.day <= 7 || n === s && r !== s) && "prev" === e && (n -= 1) <= 0 && (a -= 1, n = 12), {
          Uyear: a,
          Umonth: n
        }
      }
      ...
      firstWeekInMonth(e, t, a) {
        ...
        return this.Component.weekMode && (o = (0, r.default)(this.Component).buildDate(e, t)), o.slice(0, a ? s + 1 : s)
      }
      lastWeekInMonth(e, t, a) {
        ...
        return this.Component.weekMode && (l = (0, r.default)(this.Component).buildDate(e, t)), l.slice(a ? o : o - 1, c)
      }
      initSelectedDay(e) {
        let t = [...e];
        const {
      ...
      setEnableAreaOnWeekMode(e = []) {
        ...
        e.forEach(e => {
          const r = d.newDate(e.year, e.month, e.day).getTime();
          let o = !1;
      ...
      calculateNextWeekDays() {
        ...
        if (t - e >= 7) {
          ...
          for (let s = e + 1; s <= t; s++) r.push({
            year: a,
            month: n,
            day: s,
            week: d.dayOfWeek(a, n, s)
          });
          const {
            Uyear: s,
            Umonth: o
      ...
      calculatePrevWeekDays() {
        ...
        if (e - 7 > 0) {
          ...
          for (let r = c - Math.abs(e - 7); r <= c; r++) n.push({
            year: t,
            month: a,
            day: r,
            week: d.dayOfWeek(t, a, r)
        ...
        debugger;
        n = this.initSelectedDay(n), this.setEnableAreaOnWeekMode(n), this.setData({
          "calendar.curYear": t,
          "calendar.curMonth": a,
          "calendar.days": n
        })
      ...
      jump({
        ...
        return new Promise(n => {
          ...
          const r = this.getCalendarConfig(),
            s = "Mon" === r.firstDayOfWeek,
            o = this.firstWeekInMonth(e, t, s);
          let c = this.lastWeekInMonth(e, t, s),
          ...
          }), this.setEnableAreaOnWeekMode(l), this.setData({
            "calendar.days": l,
            "calendar.curYear": e,
            "calendar.curMonth": t,
            "calendar.empytGrids": [],
      ...
      __calculateDatesWhenInFirstWeek(e, t) {
        ...
        if (a.length < 7) {
          let e, {
            ...
            r = 7 - a.length;
          for (n > 1 ? (n -= 1, e = d.thisMonthDays(t, n)) : (n = 12, t -= 1, e = d.thisMonthDays(t, n)); r;) a.unshift({
            year: t,
            month: n,
            day: e,
      ...
      __calculateDates({
        ...
        let o = [a - s, a + (6 - s)];
        return n && (o = [a + 1 - s, a + (7 - s)]), (0, r.default)(this.Component).buildDate(e, t).slice(o[0] - 1, o[1])
      }
      __dateIsInWeek(e, t) {
        return t.find(t => +t.year == +e.year && +t.month == +e.month && +t.day == +e.day)
      }
      __tipsWhenCanNotSwtich() {
        b.info("当前月份未选中日期下切换为周视图，不能明确该展示哪一周的日期，故此情况不允许切换")
      }
    }
    t.default = e => new f(e)
  },
    ...
    class d extends r.default {
      ...
      renderCalendar(e, t, a) {
        return new Promise(r => {
          ...
          s && s instanceof Array && s.find(e => +e.month == +t) && (0, n.default)(this.Component).setTodoLabels(), this.Component.firstRender ? r({
            firstRender: !1
          }) : r({
            firstRender: !0
          })
      ...
      calculateNextMonthGrids(e, t) {
        ...
        for (let n = 1; n <= c; n++) d ? a.push("") : a.push({
          day: n,
          lunar: b ? s.default.solar2lunar(e, t + 1, n) : null
        });
        this.setData({
      ...
      isTiaoxiu(day) {
        var res = 0;
        for (var i = 0; i < tiaoxiu.length; i++) {
          if (day === tiaoxiu[i]) {
            res = 1;
          }
        }
      ...
      buildDate(e, t) {
        ...
        for (let s = 1; s <= n; s++) {
          ...
          var daystr = e + m + day
          var isHolidayInt = this.isHoliday(daystr)
          var isTiaoxiuInt = this.isTiaoxiu(daystr)
          console.log('day is :' + daystr + ",res:" + isHolidayInt)
          const n = +a.year == +e && +a.month == +t && s === +a.date,
          ...
          r.push({
            ...
            isHoliday: isHolidayInt==1,
            isTiaoxiu: isTiaoxiuInt ==1
          })
        }
        return r
      }
      calculateDays(e, t, a) {
        ...
        n.forEach(e => {
          ...
          n && (e.lunar = s.default.solar2lunar(+e.year, +e.month, +e.day));
          let f = !1;
          
          o ? f = o && a - r < 0 && !e.disable : c && (f = c && a - r > 0 && !e.disable), (f || this.__isDisable(a)) && (e.disable = !0, e.choosed = !1)
        }), this.setData({
          "calendar.days": n,
      ...
      __isDisable(e) {
        ...
        let r = !1,
          s = (0, o.converEnableDaysToTimestamp)(a);
        return t.length && (s = (0, o.delRepeatedEnableDay)(a, t)), n.length ? (+n[0] > +e || +e > +n[1]) && !s.includes(+e) && (r = !0) : s.length && !s.includes(+e) && (r = !0), r
      }
    }
    t.default = e => new d(e)
  },
  function (e, t, a) {
    ...
    class c extends r.default {
      ...
      setTodoLabels(e) {
        ...
        for (let e of D) {
          let t;
          (t = this.Component.weekMode ? a.find(t => +e.year == +t.year && +e.month == +t.month && +e.day == +t.day) : a[e.day - 1]) && (t.showTodoLabel = !!b || !t.choosed, t.showTodoLabel && e.todoText && (t.todoText = e.todoText))
        }
        const g = {
          "calendar.days": a,
          "calendar.todoLabels": (0, s.uniqueArrayByDate)(f.concat(i))
        };
        debugger;
        c || (d && d !== h && (g["calendar.todoLabelPos"] = d), l && l !== u && (g["calendar.todoLabelColor"] = l)), g["calendar.todoLabelCircle"] = c || !1, g["calendar.showLabelAlways"] = b || !1, this.setData(g)
      }
      deleteTodoLabels(e) {
  ...
  function (e, t, a) {
    ...
    Component({
      ...
      attached: function () {
        this.initComp()
        console.log('attachedhahahhhaah')
      },
       methods: {
        initComp() {
        ...
        tapDayItem(e) {
          ...
          r ? o.whenMulitSelect.call(this, t) : o.whenSingleSelect.call(this, t)
        }, 
        doubleClickToToday() {
        ...
        calendarTouchmove(e) {
          ...
          if (this.slideLock && !a) {
            if (c.isLeft(t, e.touches[0])) {
              ...
              }), this.currentYM = (0, o.getCurrentYM)(), this.weekMode) return this.slideLock = !1, this.currentDates = (0, o.getCalendarDates)(), (0, r.default)(this).calculateNextWeekDays(), this.onSwipeCalendar("next_week"), void this.onWeekChange("next_week");
              this.chooseMonth("next_month"), this.onSwipeCalendar("next_month"), this.slideLock = !1
            }
            if (c.isRight(t, e.touches[0])) {
              if (this.setData({
                "calendar.rightSwipe": 1
              }), this.currentYM = (0, o.getCurrentYM)(), this.weekMode) return this.slideLock = !1, this.currentDates = (0, o.getCalendarDates)(), (0, r.default)(this).calculatePrevWeekDays(), this.onSwipeCalendar("prev_week"), void this.onWeekChange("prev_week");
              this.chooseMonth("prev_month"), this.onSwipeCalendar("prev_month"), this.slideLock = !1
            }
          }
        }, 
        calendarTouchend(e) {
  ...
  function (e, t, a) {
    ...
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), t.getCurrentYM = L, t.getSelectedDay = v, t.cancelAllSelectedDay = W, t.jump = S, t.setTodoLabels = $, t.deleteTodoLabels = Y, t.clearTodoLabels = O, t.getTodoLabels = x, t.disableDay = A, t.enableArea = E, t.enableDays = I, t.setSelectedDays = P, t.getCalendarConfig = j, t.setCalendarConfig = G, t.getCalendarDates = U, t.switchView = F, t.default = t.calculateNextWeekDays = t.calculatePrevWeekDays = t.whenMulitSelect = t.whenSingleSelect = t.renderCalendar = t.whenChangeDate = void 0;
    var n = f(a(9)),
      r = f(a(4)),
      s = f(a(6)),
      o = f(a(0)),
    ...
    const p = {
      renderCalendar(e, t, a) {
        return (0, b.isComponent)(this) && (i = this), new Promise((n, r) => {
          (0, c.default)(i).renderCalendar(e, t, a).then((e = {}) => {
            e.firstRender && (! function (e) {
              e.calendar = {
                jump: S,
                switchView: F,
                disableDay: A,
            ...
            }((0, b.getCurrentPage)()), i.triggerEvent("afterCalendarRender", i), i.firstRender = !0, b.initialTasks.flag = "finished", b.initialTasks.tasks.length && b.initialTasks.tasks.shift()(), n())
          })
        })
      }, whenChangeDate({
        curYear: e,
        ...
        const {
          ...
          days: a,
          todoLabels: n
        } = t, r = (0, l.default)(i).getCalendarConfig();
        let {
          selectedDay: s = []
        } = t;
        const o = a[e];
        if (o) {
          if (o.choosed = !o.choosed, o.choosed) {
            ...
            s = s.filter(t => e !== `${t.year}-${t.month}-${t.day}`), n && n.forEach(t => {
              e === `${t.year}-${t.month}-${t.day}` && (o.showTodoLabel = !0)
            })
          } if (r.takeoverTap) return i.triggerEvent("onTapDay", o);
          g({
            "calendar.days": a,
        ...
        i.weekMode && a.forEach((e, t) => {
          e.day === d && (a[t].choosed = !1)
        }), r && (o = r.filter(e => +e.year === u && +e.month === h)), (0, s.default)(i).showTodoLabels(o, a, n);
        const m = {
          "calendar.days": a
        };
        f.day !== c.day ? (f.choosed = !1, c.choosed = !0, t.showLabelAlways && c.showTodoLabel || (c.showTodoLabel = !1), m["calendar.selectedDay"] = [c]) : y.inverse && (c.choosed = !c.choosed, c.choosed && (c.showTodoLabel && t.showLabelAlways ? c.showTodoLabel = !0 : c.showTodoLabel = !1), m["calendar.selectedDay"] = []), g(m)
      }, afterTapDay(e, t) {
        const a = (0, l.default)(i).getCalendarConfig(),
          {
            multi: n
          } = a;
        n ? i.triggerEvent("afterTapDay", {
          currentSelected: e,
          selectedDays: t
        ...
        const {
          ...
          month: t,
          date: a
        } = u.todayDate(), n = u.todayTimestamp();
        g({
          "calendar.curYear": e,
          "calendar.curMonth": t,
          "calendar.selectedDay": [{
            ...
            month: t,
            choosed: !0,
            lunar: (0, l.default)(i).getCalendarConfig().showLunar ? d.default.solar2lunar(e, t, a) : null
          }],
    ...
    function S(e, t, a, n) {
      ...
      if (+c != +e || +l != +t || +d != +a) {
        if (o) return (0, r.default)(i).jump({
          year: e,
          month: t,
          day: a
        });
    ...
    function $(e, t) {
      m(t), (0, s.default)(i).setTodoLabels(e)
    }

    function Y(e, t) {
      m(t), (0, s.default)(i).deleteTodoLabels(e)
    }

    function O(e) {
      m(e), (0, s.default)(i).clearTodoLabels()
    }

    function x(e) {
      return m(e), (0, s.default)(i).getTodoLabels()
    }
    ...
    function j(e) {
      return m(e), (0, l.default)(i).getCalendarConfig()
    }

    function G(e, t) {
      return m(t), e && 0 !== Object.keys(e).length ? new Promise((t, a) => {
        (0, l.default)(i).setCalendarConfig(e).then(e => {
          t(e)
        }).catch(e => {
          a(e)
        })
    ...
    function F(...e) {
      return new Promise((t, a) => {
        const n = e[0];
        if (!e[1]) return (0, r.default)(i).switchWeek(n).then(t).catch(a);
        "string" == typeof e[1] ? (m(e[1]), (0, r.default)(i).switchWeek(n, e[2]).then(t).catch(a)) : "object" == typeof e[1] && ("string" == typeof e[2] && m(e[1]), (0, r.default)(i).switchWeek(n, e[1]).then(t).catch(a))
      })
    }

    function R(e, t) {
      b.initialTasks.flag = "process", (i = e).config = t,
        function (e) {
          let t = ["日", "一", "二", "三", "四", "五", "六"];
          "Mon" === e && (t = ["一", "二", "三", "四", "五", "六", "日"]), g({
            "calendar.weeksCh": t
          })
        }(t.firstDayOfWeek),
        function (e) {
    ...
    t.default = (e, t = {}) => {
      if ("process" === b.initialTasks.flag) return b.initialTasks.tasks.push(function () {
        R(e, t)
      });
      R(e, t)
    }
  ...
  function (e, t, a) {
    ...
    class d extends n.default {
      ...
      enableArea(e = []) {
        if (2 === e.length) {
          ...
          if (this.__judgeParam({
            ...
            const s = this.__handleEnableArea({
              area: e,
              days: t,
              startTimestamp: n,
              endTimestamp: r
        ...
        } else c.warn('enableArea()参数需为时间范围数组，形如：["2018-8-4" , "2018-8-24"]')
      }
      enableDays(e = []) {
        const {
          enableArea: t = []
      ...
      setSelectedDays(e) {
        if (!(0, r.default)(this.Component).getCalendarConfig().multi) return c.warn("单选模式下不能设置多日期选中，请配置 multi");
        let {
          days: t
      ...
      disableDays(e) {
        ...
        if ("[object Array]" !== Object.prototype.toString.call(e)) return c.warn("disableDays 参数为数组");
        let n = [];
        if (e.length) {
          const r = (n = (0, s.uniqueArrayByDate)(e.concat(t))).map(e => `${e.year}-${e.month}-${e.day}`);
          a.forEach(e => {
            const t = `${e.year}-${e.month}-${e.day}`;
      ...
      __judgeParam(e) {
        ...
        return t[2] > n || t[2] < 1 ? (c.warn("enableArea() 开始日期错误，指定日期不在当前月份天数范围内"), !1) : t[1] > 12 || t[1] < 1 ? (c.warn("enableArea() 开始日期错误，月份超出1-12月份"), !1) : a[2] > r || a[2] < 1 ? (c.warn("enableArea() 截止日期错误，指定日期不在当前月份天数范围内"), !1) : a[1] > 12 || a[1] < 1 ? (c.warn("enableArea() 截止日期错误，月份超出1-12月份"), !1) : !(s > o) || (c.warn("enableArea()参数最小日期大于了最大日期"), !1)
      }
      __handleEnableArea(e = {}, t = []) {
        ...
        let d = [];
        c.length && (d = (0, s.delRepeatedEnableDay)(c, a));
        const b = [...n];
        return b.forEach(e => {
          const a = l.newDate(e.year, e.month, e.day).getTime();
          (+r > +a || +a > +o) && !d.includes(+a) ? (e.disable = !0, e.choosed && (e.choosed = !1, t = t.filter(t => `${e.year}-${e.month}-${e.day}` !== `${t.year}-${t.month}-${t.day}`))) : e.disable && (e.disable = !1)
        }), {
            dates: b,
            selectedDay: t
          }
      ...
      __handleEnableDays(e = {}, t = []) {
        ...
        return s.forEach(e => {
          const a = l.newDate(e.year, e.month, e.day).getTime();
          let s = !1;
          r.length ? (+r[0] > +a || +a > +r[1]) && !n.includes(+a) && (s = !0) : n.includes(+a) || (s = !0), s ? (e.disable = !0, e.choosed && (e.choosed = !1, t = t.filter(t => `${e.year}-${e.month}-${e.day}` !== `${t.year}-${t.month}-${t.day}`))) : e.disable = !1
        }), {
            dates: s,
            selectedDay: t
          }
      ...
      __handleSelectedDays(e = [], t = [], a) {
        ...
        return t.forEach(e => {
          +e.year == +o && +e.month == +c && l.push(`${e.year}-${e.month}-${e.day}`)
        }), [...e].map(e => {
          l.includes(`${e.year}-${e.month}-${e.day}`) && (e.choosed = !0, r && e.showTodoLabel ? e.showTodoLabel = !0 : e.showTodoLabel = !1)
        }), {
            dates: e,
            selectedDates: t
          }
